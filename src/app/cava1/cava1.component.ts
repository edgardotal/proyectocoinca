...
@Component({
  selector: 'app-cava1',
  templateUrl: './cava1.component.html',
  styleUrls: ['./cava1.component.scss']
})
export class Cava1Component implements AfterViewInit {
  title = 'Coinca';
  ...
  if (this.cavaContainer) {
    // Esperar a que el contenido se haya renderizado por completo
    setTimeout(() => {
  ...
  // Desplazar la ventana del navegador al final de la página, después de que todo esté cargado
  setTimeout(() => {
